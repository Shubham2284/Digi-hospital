    ...
    <div class="sidebar">
        <div class="sidebar-wrapper">
                ...
                <div class="p-xl-20 p-10 ">
                    ...
                    <div class="py-20 bb-2 bt-1">
                        <a class="sidebar-user" href="javascript:void(0)">
                            ...
                            <span class="para-1b show-item ms-10">Welcome, <?php echo $user_data['user_name']; ?></span>
                        </a>
                    </div>
                </div>
                <div class="side-menu">
                    <ul>
                        ...
                        <li>
                            <a href="doctor.html">
                                ...
                                <span class="show-item"> Doctor</span>
                            </a>
                        </li>
                        <li>
                            <a href="../adminphp/addreception.php">
                                <i class="fa-solid fa-user-doctor"></i>
                                <span class="show-item"> Add-Reception</span>
                            </a>
                        </li>
                        <li>
                            <a href="../adminphp/addmedical.php">
                                <i class="fa-solid fa-user-doctor"></i>
                                <span class="show-item"> Add-Medical</span>
                            </a>
                        </li>
                        <li>
                            <a href="../adminphp/adddoctor.php">
                                <i class="fa-solid fa-user-doctor"></i>
                                <span class="show-item"> Add-Doctor</span>
                            </a>
                        </li>
                    </ul>
                </div>
            ...
            <button class="log-out">
                ...
                <a href="logout.php" class="show-item">Log Out
                </a>
            </button>
        </div>
    </div>
    ...
    <main class="content-wrapper">
        ...
        <header>
            ...
            <div class="d-flex align-items-center gap-sm-4 gap-3">
                ...
                <div class="account">
                    <img class="me-xl-10" src="../assets/img/admin.png" alt="patient">
                    ...
                    <div class="col-xxl-3 col-lg-4 col-md-6">
                        <div class="card-box">
                            ...
                            <div class="card-box-icon bgpc-1">
                                <img src="../assets/img/icon/setting.png" alt="setting">
                            </div>
                        </div>
                    </div>
                    <div class="col-xxl-3 col-lg-4 col-md-6">
                        <div class="card-box">
                            ...
                            <div class="card-box-icon bgc-3">
                                <img src="../assets/img/icon/doctor.png" alt="doctor">
                            </div>
                        </div>
                    </div>
                    <div class="col-xxl-3 col-lg-4 col-md-6">
                        <div class="card-box">
                            ...
                            <div class="card-box-icon bgpc-1">
                                <img src="../assets/img/icon/patient.png" alt="patient">
                            </div>
                        </div>
                    </div>
                    <div class="col-xxl-3 col-lg-4 col-md-6">
                        <div class="card-box">
                            ...
                            <div class="card-box-icon bgc-4">
                                <img src="../assets/img/icon/appointment.png" alt="appointment">
                            </div>
                        </div>
                    </div>
                    <div class="col-xxl-3 col-lg-4 col-md-6">
                        <div class="card-box">
                            ...
                            <div class="card-box-icon bgc-4">
                                <img src="../assets/img/icon/paper.png" alt="paper">
                            </div>
                        </div>
                    </div>
                    <div class="col-xxl-3 col-lg-4 col-md-6">
                        <div class="card-box">
                            ...
                            <div class="card-box-icon bgpc-1">
                                <img src="../assets/img/icon/invoice.png" alt="invoice">
                            </div>
                        </div>
                    </div>
                    <div class="col-xxl-3 col-lg-4 col-md-6">
                        <div class="card-box">
                            ...
                            <div class="card-box-icon bgc-3">
                                <img src="../assets/img/icon/pills.png" alt="pills">
                            </div>
                        </div>
                    </div>
                    <div class="col-xxl-3 col-lg-4 col-md-6">
                        <div class="card-box">
                            ...
                            <div class="card-box-icon bgpc-1">
                                <img src="../assets/img/icon/payment.png" alt="payment">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <footer>
                <div class="container-fluid">
                    <span class="para-1b fs-base text-center text-sm-start d-block ">Copyright © <span
                            class="currentYear"></span> E-Hospital Medical. All
