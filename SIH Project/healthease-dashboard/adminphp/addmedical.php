...
include("../medicalmodule/functions.php");
...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    if (!empty($user_name) && !empty($password) && !is_numeric($user_name)) {
        ...
        $query = "INSERT INTO medicaluser (user_id, user_name, password) VALUES ('$user_id', '$user_name', '$hashed_password')";

        if (mysqli_query($con, $query)) {
            // Redirect to login page after successful registration
            header("Location: addmedical.php");
            die;
        } else {
