...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    if (!empty($user_name) && !empty($password) && !is_numeric($user_name)) {
        ...
        $query = "INSERT INTO admins (user_id, user_name, password) VALUES ('$user_id', '$user_name', '$hashed_password')";
                ...
                <div class="login-form">
                    ...
                    <form action="#" id="mainform" method="post">
                        ...
                        <div class="my-sm-30 my-3 d-between">
                          ...
                          <a href="javascript:void(0)" class="para-1b fs-base tsc-1">Forgot password?</a>
-->
                        </div>
                    ...
                    <div class="text-center">
                        <span class="para-1b fs-base">Already Registered ?<a href="login.php"
                                class="tpc-2">Go To Login</a></span>
                    </div>
                </div>
            </div>
